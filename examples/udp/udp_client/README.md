...
If you want to test with the UDP Client example using SPI DMA, uncomment USE_SPI_DMA.
...
2. Setup network configuration such as IP in 'w5x00_udp_client.c' which is the UDP Client example in 'WIZnet-PICO-C/examples/udp/udp_client' directory.
...
3. Setup UDP Client configuration in 'w5x00_udp_client.c' in 'WIZnet-PICO-C/examples/udp/udp_client' directory.
...
2. When the build is completed, 'w5x00_udp_client.uf2' is generated in 'WIZnet-PICO-C/build/examples/udp/udp_client' directory.
...
2. Drag and drop 'w5x00_udp_client.uf2' onto the USB mass storage device 'RPI-RP2'.
...
5. If the UDP Client example works normally on Raspberry Pi Pico, W5100S-EVB-Pico, W5500-EVB-Pico, W55RP20-EVB-Pico, W5100S-EVB-Pico2 or W5500-EVB-Pico2, you can see the network information of Raspberry Pi Pico, W5100S-EVB-Pico, W5500-EVB-Pico, W55RP20-EVB-Pico, W5100S-EVB-Pico2 or W5500-EVB-Pico2 and the UDP Client is open.
