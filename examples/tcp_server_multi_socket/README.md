...
If you want to test with the TCP server multi socket example using SPI DMA, uncomment USE_SPI_DMA.
...
2. Setup network configuration such as IP in 'w5x00_tcp_server_multi_socket.c' which is the TCP server multi socket example in 'WIZnet-PICO-C/examples/tcp_server_multi_socket/' directory.
...
3. Setup TCP server multi socket configuration in 'w5x00_tcp_server_multi_socket.c' in 'WIZnet-PICO-C/examples/tcp_server_multi_socket/' directory.
...
2. When the build is completed, 'w5x00_tcp_server_multi_socket.uf2' is generated in 'WIZnet-PICO-C/build/examples/tcp_server_multi_socket/' directory.
...
2. Drag and drop 'w5x00_tcp_server_multi_socket.uf2' onto the USB mass storage device 'RPI-RP2'.
