...
2. Setup network configuration such as IP in 'w5x00_mqtt_subscribe.c' which is the MQTT Subscribe example in 'WIZnet-PICO-C/examples/mqtt/subscribe/' directory.
...
3. Setup MQTT configuration in 'w5x00_mqtt_subscribe.c' in 'WIZnet-PICO-C/examples/mqtt/subscribe/' directory.
...
2. When the build is completed, 'w5x00_mqtt_subscribe.uf2' is generated in 'WIZnet-PICO-C/build/examples/mqtt/subscribe/' directory.
