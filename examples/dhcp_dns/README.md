...
2. Setup network configuration such as IP in 'w5x00_dhcp_dns.c', which is the DHCP & DNS example in 'WIZnet-PICO-C/examples/dhcp_dns/' directory.
...
Setup the domain name that you want to get IP in 'w5x00_dhcp_dns.c' in 'WIZnet-PICO-C/examples/dhcp_dns/' directory.
...
2. When the build is completed, 'w5x00_dhcp_dns.uf2' is generated in 'WIZnet-PICO-C/build/examples/dhcp_dns/' directory.
